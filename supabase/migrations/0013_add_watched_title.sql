...
-- every physical copy a matched watch-history log resolves to, even when the log's
-- disc-format tag doesn't confirm which specific copy. Defaults to false, same reasoning as `watched`:
