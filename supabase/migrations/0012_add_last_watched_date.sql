...
-- (0011_backfill_rescan_fields.sql). Added ahead of a planned one-time watch-history diary
-- export import (Claude/TECH STACK AND ARCHITECTURE.md) - the user's own diary export
...
-- answer. A plain `date` (not `timestamptz`) since that diary export only ever records a
